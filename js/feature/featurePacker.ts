...
function pack(featureList: PackableFeature[], maxRows?: number): void {

    maxRows = maxRows || Number.MAX_SAFE_INTEGER
    const rows: number[] = []
    featureList.sort(function (a: PackableFeature, b: PackableFeature): number {
