const encodings: Map<string, string> = new Map([
    ["%09", "\t"],
    ["%0A", "\n"],
    ["%0D", "\r"],
    ["%25", "%"],
...
function decodeGFFAttribute(str: string): string {
 ...
 */
function parseAttributeString(attributeString: string, keyValueDelim: string = "="): [string, string][] {
