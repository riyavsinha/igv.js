...
const distinctColorsPaletteSrcStrings: string[] =
    [
            'rgb(230, 25, 75)',
            'rgb(60, 180, 75)',
            'rgb(255, 225, 25)',
...
const _18_DistinctColorsViaChatGPT4: string[] = [
    "rgb(255, 0, 0)",     // Red
    "rgb(0, 255, 0)",     // Green
    "rgb(0, 0, 255)",     // Blue
...
const distinctColorsPalette: string[][] = _18_DistinctColorsViaChatGPT4.map((str: string) => {
