...
const viewportColumnManager =
    {
        createColumns: (columnContainer: HTMLElement, count: number): void => {
        ...
        removeColumnAtIndex: (i: number, column: HTMLElement): void => {
            const shim = 0 === i ? column.nextElementSibling : column.previousElementSibling
            column.remove()
            shim!.remove()
        },

        insertAfter: (referenceElement: HTMLElement): HTMLElement => {
        ...
        insertBefore: (referenceElement: HTMLElement, count: number): void => {
        ...
        indexOfColumn: (columnContainer: HTMLElement, column: HTMLElement): number | undefined => {
